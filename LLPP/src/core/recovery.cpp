...
namespace llpp::core
{
	...
	void reconnect_to_server()
	{
		...
		while (true) {
			if (asa ::entities::local_player->is_alive() ||
				asa::interfaces::spawn_map->is_open()) {
				break;
			}
	...
	void inform_crash_detected(asa::core::ShooterGameError& e)
	{
		...
		embed.set_color(0xB82E88)
			...
			.set_thumbnail("https://static.wikia.nocookie.net/"
						   ...
						   "images/5/53/Mission_Area.png/revision/"
						   "latest?cb=20200314145130")
	...
	void inform_recovery_initiated(const bool restart, const bool reconnect)
	{
		...
		embed.set_color(0x7F5D44)
			...
			.set_thumbnail("https://static.wikia.nocookie.net/"
						   "arksurvivalevolved_gamepedia/"
						   "images/2/24/Crafting_Light.png/revision/"
						   "latest?cb=20181217123945")
