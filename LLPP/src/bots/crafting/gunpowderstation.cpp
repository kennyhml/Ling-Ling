...
{
    GunpowderStation::GunpowderStation(const std::string& t_name,
    ...
    core::StationResult GunpowderStation::complete()
    {
        ...
        send_gunpowder_crafted(res);
        return res;
    }

    void GunpowderStation::empty_chembench()
    {
    ...
    void GunpowderStation::queue_new()
    {
        asa::entities::local_player->access(chem_bench_);
        chem_bench_.get_inventory()->craft(*asa::items::resources::gunpowder, 1000);
        chem_bench_.get_inventory()->close();
