...
namespace llpp::bots::farm
{
    ...
    namespace
    {
        ...
        discord::ManagedCommand command("obsidian", "Controls the Obsidian Managers.", 0,
    ...
    void register_obsidian_commands()
    {
