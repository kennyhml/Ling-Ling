...
namespace llpp::bots::drops
{
                        ...
                        std::map<std::string, bool> cherry_picked)
    {
        ...
        auto message = dpp::message(1178962441091162173, "<@&1184887046184108052>");
    ...
    void send_summary_embed(const std::string& name, std::chrono::seconds time_taken,
                            ...
                            std::chrono::system_clock::time_point next_completion)
    {
        ...
        embed.set_color(dpp::colors::yellow).
              ...
              add_field("Time taken:", std::format("{} seconds", time_taken.count()),
                        true).add_field("Vault filled:", std::format("{}%", vault_slots),
                                        true).add_field(
                  "Next completion:",
                  std::format("<t:{}:R>",
